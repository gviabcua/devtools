<?php namespace Gviabcua\DevTools\Controllers;
...
use Exception;
use BackendMenu;
use Gviabcua\DevTools\Classes\Asset;
use Gviabcua\DevTools\Widgets\AssetList;
use Cms\Classes\Router;
use Backend\Classes\Controller;
use Backend\Classes\WidgetManager;
use System\Helpers\DateTime;
use Winter\Storm\Router\Router as WinterRouter;
...
class Editor extends Controller
{
    ...
    public $requiredPermissions = ['gviabcua.devtools.editor'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Gviabcua.DevTools', 'editor', 'assets');
    ...
    {
        $this->addJs('/plugins/gviabcua/devtools/assets/october.cmspage.js');
    ...
    {
        $formConfigs = [
            'asset' => '~/plugins/gviabcua/devtools/classes/asset/fields.yaml'
        ];
